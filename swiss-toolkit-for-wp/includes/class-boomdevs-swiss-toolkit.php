...
if (!class_exists('BDSTFW_Swiss_Toolkit')) {
	class BDSTFW_Swiss_Toolkit
	{
		...
		private function load_dependencies()
		{
			...
			require_once plugin_dir_path(dirname(__FILE__)) . 'includes/plugins/class-boomdevs-swiss-toolkit-extension-attachment.php';
			...
			require_once plugin_dir_path(dirname(__FILE__)) . 'includes/plugins/class-boomdevs-swiss-toolkit-admin-login-url.php';
			...
			require_once plugin_dir_path(dirname(__FILE__)) . 'optimizations/class-boomdevs-swiss-toolkit-optimizations.php';
