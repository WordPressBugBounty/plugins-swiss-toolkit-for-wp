...
class BoomDevs_Notification_Widget_swiss_toolkit
{
    private $plugin_slug = 'swiss-toolkit-for-wp';
    private $transient_key = 'swiss-toolkit-for-wp';
    private $api_url;

    public function __construct() {
        $this->api_url = DSTFW_SWISS_BACKEND_URL;
  ...
  public function enqueue_scripts() {
    ...
    // CSS enqueue
    wp_enqueue_style(
        'boomdevs-swiss-notification-css',
        plugin_dir_url(dirname(__FILE__)) . 'admin/css/boomdevs-notification-widget-swiss-toolkit.css',
        array(),
        $version
    );
    ...
    // JS enqueue
    wp_enqueue_script(
        'boomdevs-swiss-notification-js',
        plugin_dir_url(dirname(__FILE__)) . 'admin/js/boomdevs-notification-widget-swiss-toolkit.js',
        array('jquery'),
        $version,
        true
    );
    ...
    wp_localize_script('boomdevs-swiss-notification-js', 'boomdevs_widget_data_swiss', [
        'plugin_slug' => 'swiss-toolkit-for-wp',
        'version'     => $version,
    ]);
}
...
new BoomDevs_Notification_Widget_swiss_toolkit;
